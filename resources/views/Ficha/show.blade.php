...
<html>
    ...
    <div class="panel panel-default margen" >
      <div class="panel-heading" >  {{$paciente->Nombre}} {{$paciente->Paterno}} {{$paciente->Materno}} {{$paciente->rut}} </div>
        <div class="panel-body">
          ...
          <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal">Ingresar</button>
  ...
  <div id="myModal" class="modal fade" role="dialog" >
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="container modalS" style="max-width:180%; margin-left:-40%; margin-top:10%;">
        {!!Form::open(['route'=>['Ficha.store'],'method'=>'POST'])!!}
        <fieldset>

        <!-- Form Name -->
        <legend style="margin-top:1.5%;">Ingreso de Ficha
        ...
        <div >
          <div class="panel-body">
            <legend style="margin-top:1.5%;">Datos Generales</legend>
               ...
               <legend style="max-width:96%; margin-left:2%;"> Anamnesis General</legend>
               <div class="panel-body">
              ...
              <legend style="max-width:96%; margin-left:2%;" > Anamnesis Odontológica</legend>
              <div class="panel-body">
                <div class="form-group col-sm-4">
